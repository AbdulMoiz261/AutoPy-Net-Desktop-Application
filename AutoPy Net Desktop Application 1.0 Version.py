...
class AutoPynetDashboard(QWidget):
    def __init__(self):
        ...
        # self.central_widget.addWidget(self.main_page)  # Main Page
        # self.central_widget.addWidget(self.choose_vendor_page)  # Choose Vendor Page
        # self.central_widget.addWidget(self.my_files_page)  # My Files Page
        # self.central_widget.addWidget(self.status_page)  # Status Page
